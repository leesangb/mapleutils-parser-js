...
// .then((e) => { console.log(e.base, e.cash, e.symbol); });

requester.getPetEquipments('https://maplestory.nexon.com/Common/Character/Detail/Lilly/Pet?p=mikO8qgdC4hElCwBGQ6GOx8CmO11EvduZkV0bRbPAhb4ju7wDUqT65UjguKUmknr6Yq8PucaLHcF0AHbQqMu0Fa8vQ2Mz%2fQEUjH5HNWhFNd5oZIZUW7AXfwY8QRBl69KsBHINBfoz6laVZGWio2nbcRbIL%2f2vzkcMur4zO%2fov3lO8HYWAwz5CpF0cq4BNn8z#a')
    .then((e) => {
        console.log(e);
    });
